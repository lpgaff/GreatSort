...
public:
	...
	// Popup dialogs
	GreatDialog( const TGWindow *p, const TGWindow *main, TString msg, bool &ans );
	virtual ~GreatDialog();
...
protected:
	...
	std::shared_ptr<GreatReaction> myrea;
...
public:
	...
	GreatGUI();				// constructor
	virtual ~GreatGUI();		// destructor
