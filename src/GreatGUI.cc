// Very basic ROOT GUI to perform sorting of Great data
//
...
GreatGUI::GreatGUI() {
	...
	// Button presses //
	//----------------//
	but_save->Connect( "Clicked()", "GreatGUI", this, "on_save_clicked()" );
	but_open->Connect( "Clicked()", "GreatGUI", this, "on_open_clicked()" );
	but_sel->Connect( "Clicked()", "GreatGUI", this, "on_sel_clicked()" );
	but_add->Connect( "Clicked()", "GreatGUI", this, "on_add_clicked()" );
	text_add_file->Connect( "ReturnPressed()", "GreatGUI", this, "on_add_clicked()" );
	but_del->Connect( "Clicked()", "GreatGUI", this, "on_del_clicked()" );
	but_sort->Connect( "Clicked()", "GreatGUI", this, "on_sort_clicked()" );
	but_set->Connect( "Clicked()", "GreatGUI", this, "on_set_clicked()" );
	but_cal->Connect( "Clicked()", "GreatGUI", this, "on_cal_clicked()" );
	but_rea->Connect( "Clicked()", "GreatGUI", this, "on_rea_clicked()" );
	but_out->Connect( "Clicked()", "GreatGUI", this, "on_out_clicked()" );
...
void GreatGUI::SaveSetup( TString setupfile ) {
...
void GreatGUI::LoadSetup( TString setupfile ) {
...
void GreatGUI::gui_convert(){
	
	//------------------------//
	// Run conversion to ROOT //
	//------------------------//
	GreatConverter conv( myset );
	conv.AddCalibration( mycal );
	conv.AddProgressBar( prog_conv );
	std::cout << "\n +++ Great Analysis:: processing Converter +++" << std::endl;
...
void GreatGUI::gui_build(){
	
	//-----------------------//
	// Physics event builder //
	//-----------------------//
	GreatEventBuilder eb( myset );
	eb.AddProgressBar( prog_evnt );
	std::cout << "\n +++ Great Analysis:: processing EventBuilder +++" << std::endl;
...
void GreatGUI::gui_hist(){
	
	//------------------------------//
	// Finally make some histograms //
	//------------------------------//
	GreatHistogrammer hist( myrea, myset );
	hist.AddProgressBar( prog_hist );
	std::cout << "\n +++ Great Analysis:: processing Histogrammer +++" << std::endl;
...
void GreatGUI::on_sort_clicked() {
	...
	myset = std::make_shared<GreatSettings>( name_set_file );
	mycal = std::make_shared<GreatCalibration>( name_cal_file, myset );
	myrea = std::make_shared<GreatReaction>( name_rea_file, myset, flag_source );
...
GreatDialog::GreatDialog( const TGWindow *p, const TGWindow *main, TString msg, bool &ans ) {
	...
	but_yes->Connect( "Clicked()", "GreatDialog", this, "SayYes()" );
	...
	but_no->Connect( "Clicked()", "GreatDialog", this, "SayNo()" );
